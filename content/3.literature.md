...
**Sovereignty** is a foundational principle in the European data landscape, The influence of non-EU tech companies has become a concern for EU policy-makers, especially with regard to their impact on the EU's data economy and innovation potential  on EU privacy and data
protection and on the establishment of a secure and safe digital environment.   https://www.europarl.europa.eu/RegData/etudes/BRIE/2020/651992/EPRS_BRI(2020)651992_EN.pdf
...
**Compliance** in decentralised ecosystems cannot rely on a single governing authority. Instead, it must be achieved through standardised rules, verification frameworks, and alignment with regulatory requirements such as the GDPR [8]. Initiatives such as Gaia-X propose federated mechanisms including Gaia-X Digital Clearing Houses that act as trusted intermediaries for data exchange across organisational and jurisdictional boundaries [5]. At their core,
The underlying idea is that data can remain under the control of its owner while still being exchangeable under verifiable rules, which distinguishes federated governance from both fully centralised and fully peer-to-peer models. - https://gaia-x.eu/services-deliverables/digital-clearing-house/
