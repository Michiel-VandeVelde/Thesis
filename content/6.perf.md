...
We measured the execution times of parsing [50 real-world SPARQL 1.1 queries from the DBpedia SPARQL Benchmark](cite:cites dbpedia-bench) in each of the tools and
<span style="word-break: break-all">[<span style="word-break: normal">provide the scripts for reproducibility</span>](https://github.com/comunica/traqula/tree/c04d10db2ece3bad5f5924c3d511c1a6cd1fe615/eval){:.mandatory}.</span>
...
For space reasons, we omit [these results](https://github.com/comunica/traqula/tree/c04d10db2ece3bad5f5924c3d511c1a6cd1fe615/eval/res-own-bench){:.mandatory} from this paper.

Despite these relative execution time increases, [](#traqula-bench) shows Traqula remains substantially faster than existing solutions.
